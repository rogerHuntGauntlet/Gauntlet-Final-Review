...
def convert_markdown_to_docx(input_dir, output_file, title="AI Engineering Thesis", author="Author Name"):
    """Convert all markdown files in input_dir to a single docx file."""
